	...
	en: {
		translation: {
			...
			query: {
				...
				pasteConfig: 'Paste JSON config here',
				import: 'Import',
				edit: 'Edit',
				env: 'Env Vars',
			...
			mcp: {
				...
				resources: 'Resources',
				noServers: 'No MCP servers configured',
				noTools: 'No tools available. Connect to a server first.',
				noResources: 'No resources available. Connect to a server first.',
				selectTool: 'Select a tool to execute.',
				selectResource: 'Select a resource to view.',
	...
	ja: {
		translation: {
			...
			mcp: {
				...
				tools: 'ツール',
				resources: 'リソース',
				noServers: 'MCPサーバーが未設定です',
				noTools: 'ツールが見つかりません。サーバーに接続してください。',
				noResources: 'リソースが見つかりません。サーバーに接続してください。',
				selectTool: '実行するツールを選択してください。',
				selectResource: '表示するリソースを選択してください。',
				execute: 'ツールを実行',
				jsonConfig: 'JSON設定',
				pasteConfig: '設定JSONを貼り付け',
				import: 'インポート',
				edit: '編集',
				env: '環境変数 (JSON)',
				envPlaceholder: '{"KEY": "VALUE"}'
